...
const createWindow = async () => {
   ...
   * toaster handler
   */
  ipcMain.on('show-toaster', (event, url, options) => {
  ...
  // todo read solution: https://github.com/electron-react-boilerplate/electron-react-boilerplate/issues/623
    const renderUrl = url.startsWith('http') ? url : `file://${__dirname}/app.html#${url}`
    toaster.loadURL(renderUrl)
  })
...
// GL errors: see https://bugs.chromium.org/p/chromium/issues/detail?id=481398
